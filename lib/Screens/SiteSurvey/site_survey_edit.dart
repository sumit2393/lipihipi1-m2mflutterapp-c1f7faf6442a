  ...
  Future<List<File>> urlToFile(List<SurveyImage> surveyImagesList) async {
    ...
    try{
        ...
        surveyImagesList.forEach((element) async {
          ...
          File file = new File('$tempPath'+ (element.id).toString() +'.png');

          http.Response response = await http.get(element.image);

          print('response: '+ element.id.toString() + response.bodyBytes.toString());
        ...
        print('completed22: ');
        print('ImageList: '+tempList.toString());
            ...
            builder: (context, res){
              ...
              if(!res.hasData){
                ...
                return FutureBuilder(
                  future: urlToFile(getSurveyDetailsResponse.message.details.surveyImages),
                  builder: (context, res){
