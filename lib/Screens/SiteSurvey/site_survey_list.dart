...
import 'package:flutterapp/Screens/SiteSurvey/site_survey_edit.dart';
...
class _SiteSurveyPageState extends State<SiteSurveyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    nonfeasible_count = notFeasibilityLiveData.length;
                                      ...
                                      onTap: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (_) =>
                                                SiteSurveyEditPage(
                                                  surveyId: completedLiveData[index].id.toString(),
                                      ...
                                      onTap: () {
                                        Navigator.of(context).push(
                                          MaterialPageRoute(
                                            builder: (_) =>
                                                SiteSurveyEditPage(
                                                  surveyId: notFeasibilityLiveData[index].id.toString(),
                                                  projectId: notFeasibilityLiveData[index].userId.toString(),
                                                  title: notFeasibilityLiveData[index].gramPanchayatName,
                                                  gpName: notFeasibilityLiveData[index].gramPanchayatName,
                                                  gpDistrictName: notFeasibilityLiveData[index].districtName,
                                                  gpStateName:notFeasibilityLiveData[index].stateName,
                                                  gpBlockName: notFeasibilityLiveData[index].blockName,
                                                  gpVillageName: notFeasibilityLiveData[index].vleName,
                                                  gpMobileNumber: notFeasibilityLiveData[index].vleMobile,
                                                ),
                                          ),
                                        );
                                      },
  ...
  listOfSurvey() async {
    ...
    var response = await http.get(
        'https://fieldapp.m2mcybernetics.com/api/v1/listOfSurvey?token=$apiToken',
    ...
    if (response.statusCode == 200) {
      ...
      try {
        if (jsonResponse["success"] == true) {
          SurveyListData otpVerificationData =
              SurveyListData.fromSurveyListJson(jsonResponse);
          if (otpVerificationData.status == true) {
            Toast.show("Survey Success", context,
            ...
            setState(() {
              ...
              notFeasibilityLiveData =
                  otpVerificationData.message.notFeasibilityData;
            });
          } else {
