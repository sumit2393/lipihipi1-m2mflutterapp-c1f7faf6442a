...
import 'package:flutterapp/Responses/GetInstallationDetailsResponse.dart';
...
class InstallationEditPage extends StatefulWidget {
  ...
  @override
  _InstallationEditPageState createState() => _InstallationEditPageState(
...
class _InstallationEditPageState extends State<InstallationEditPage> {
  final String installationId;
  final String projectId;
  final String title;
  final String gpName;
...
//    }
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: FutureBuilder(
                  future: getInstallationDetailsList(widget.installationId),
                  builder: (context, res){
                    ...
                    if(!res.hasData){
                      ...
                      GetInstallationDetailsResponse getInstallationDetailsResponse = GetInstallationDetailsResponse.fromJson(res.data);

                      if(counter==0) {

                        pole_installed = getInstallationDetailsResponse.message.details['pole_installed']==null? 'No':
                        getInstallationDetailsResponse.message.details['pole_installed'].toString()=='0'? 'No': 'Yes';

                        solor_panel_installed= getInstallationDetailsResponse.message.details['solor_panel_installed']==null? 'No':
                        getInstallationDetailsResponse.message.details['solor_panel_installed'].toString()=='0'? 'No': 'Yes';

                        solor_battery_installed =getInstallationDetailsResponse.message.details['solor_battery_installed']==null? 'No':
                        getInstallationDetailsResponse.message.details['solor_battery_installed'].toString()=='0'? 'No': 'Yes';

                        access_point_installed= getInstallationDetailsResponse.message.details['access_point_installed']==null? 'No':
                        getInstallationDetailsResponse.message.details['access_point_installed'].toString()=='0'? 'No': 'Yes';

                        poe_cabel_connected= getInstallationDetailsResponse.message.details['poe_cabel_connected']==null? 'No':
                        getInstallationDetailsResponse.message.details['poe_cabel_connected'].toString()=='0'? 'No': 'Yes';

                        ac_power_supply= getInstallationDetailsResponse.message.details['ac_power_supply']==null? 'No':
                        getInstallationDetailsResponse.message.details['ac_power_supply'].toString()=='0'? 'No': 'Yes';

                        access_point_powered= getInstallationDetailsResponse.message.details['access_point_powered']==null? 'No':
                        getInstallationDetailsResponse.message.details['access_point_powered'].toString()=='0'? 'No': 'Yes';

                        poe_cable_module_data_part= getInstallationDetailsResponse.message.details['poe_cable_module_data_part']==null? 'No':
                        getInstallationDetailsResponse.message.details['poe_cable_module_data_part'].toString()=='0'? 'No': 'Yes';

                        switch_on_the_ont_power= getInstallationDetailsResponse.message.details['switch_on_the_ont_power']==null? 'No':
                        getInstallationDetailsResponse.message.details['switch_on_the_ont_power'].toString()=='0'? 'No': 'Yes';

                        ont_power_light_is_stable= getInstallationDetailsResponse.message.details['ont_power_light_is_stable']==null? 'No':
                        getInstallationDetailsResponse.message.details['ont_power_light_is_stable'].toString()=='0'? 'No': 'Yes';

                        pon_light_is_stable= getInstallationDetailsResponse.message.details['pon_light_is_stable']==null? 'No':
                        getInstallationDetailsResponse.message.details['pon_light_is_stable'].toString()=='0'? 'No': 'Yes';

                        connent_through_mobile= getInstallationDetailsResponse.message.details['connent_through_mobile']==null? 'No':
                        getInstallationDetailsResponse.message.details['connent_through_mobile'].toString()=='0'? 'No': 'Yes';

                        open_google_com=getInstallationDetailsResponse.message.details['open_google_com']==null? 'No':
                        getInstallationDetailsResponse.message.details['open_google_com'].toString()=='0'? 'No': 'Yes';

                        name_and_number_correct = getInstallationDetailsResponse.message.details['name_and_number_correct']==null? 'No':
                        getInstallationDetailsResponse.message.details['name_and_number_correct'].toString()=='0'? 'No': 'Yes';
  ...
  Future<dynamic> getInstallationDetailsList(String installation_id) async {
    setState(() {
      isLoading = true;
    });
    isToken = false;
    var response = await http.get(
        'https://fieldapp.m2mcybernetics.com/api/v1/getInstallationDetails?token=$apiToken&installation_id=$installation_id',
        headers: {'authkey': 'Bcju0SQW2RKR0vhLzGbjeQwqkJvBUyA4IkMDuNubQq5'});
    if (response.statusCode == 200) {
      try {
        var responseJson = json.decode(response.body);
        _stopAnimation();
        print('getInstallationDetailsResponse: '+responseJson.toString());
        return responseJson;
      } catch (e) {
        _stopAnimation();
        print(e);
